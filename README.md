...
| WatchDog | Description | Technical Link                                     |
| :--- | :--- |:---------------------------------------------------|
| **LogDog** | The loyal hounds sniffing out every event, ensuring unified, color-coded logging across all buildings. | [View Documentation](./watchDogs/logDog/README.md) |
