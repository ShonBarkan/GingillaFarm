...
| Name | Character (Emoji or HTML Image)                                                            | Duty | Catchphrase | Link |
|------|--------------------------------------------------------------------------------------------|------|-------------|------|
| **LogDog** |  <!-- OR --> <br> <img src="../assets/watchdogs/logdog.png" width="40" alt="LogDog">           | Sniffs out every API call and system error across Python and Node.js. | "A sharp bark for every spark." | View Docs |
| **HealthDog** |  <!-- OR --> <br> <img src="../assets/watchdogs/HealthDog.png" width="40" alt="HealthDog">     | Checks database heartbeats and service availability every morning. | "A farm is only as strong as its fences." | View Docs |
| **BlueprintDog** | <!-- OR --> <br> <img src="../assets/watchdogs/blueprintDog.png" width="40" alt="BlueprintDog"> | Builds new services and inspects structures for Docker and Lore compliance. | "Measure twice, bark once." | View Docs |
